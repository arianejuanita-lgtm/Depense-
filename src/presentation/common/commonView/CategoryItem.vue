...
<template>
    <Card class="min-w-[110px] max-w-[140px] h-1 relative flex items-center justify-center border-bleu-clair dark:border-gray-700 bg-blanc dark:bg-gray-800 shadow-sm rounded-lg overflow-visible">
